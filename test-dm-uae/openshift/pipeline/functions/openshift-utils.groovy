...
def applyTemplateFile(project, templateFile, appName, appVersion, imageStreamName, customParameters, skipObjects) {
   ...
   openshift.withProject( project ) {
      ...
      def models = openshift.process( readFile(file:templateFile), "-p APPLICATION_NAME=${appName}", "-p APP_VERSION=${appVersion}", customParameters )
...
// for strategy RECREATE oc deploy lastest sos-bpms 
// below is doing oc rollout latest sos-bpms for strategy ROLLING
