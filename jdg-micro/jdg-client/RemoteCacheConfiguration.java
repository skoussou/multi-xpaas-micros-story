...
import com.redhat.consulting.jdg.domain.IncidentCombined;
    ...
    private void registerSchemasAndMarshallers() {
        try {
        	...
        	String incidentSchemaFile = protoSchemaBuilder
        	    ...
        	    .addClass(IncidentCombined.class)
        	    .build(serCtx);

        	// the types can be marshalled now
        	log.info("Can marshal Incident.class now = "+serCtx.canMarshall(IncidentCombined.class) );
