...
echo curl -X POST "${SERVICE}/kie-server/services/rest/server/containers/instances/payments" -u "${KIE_USERNAME}:${KIE_PASSWORD}!" -H  "accept: application/json" -H  "content-type: application/json" -d @${VARIABLE}

curl -X POST "${SERVICE}/kie-server/services/rest/server/containers/instances/payments" -u "${KIE_USERNAME}:${KIE_PASSWORD}" -H  "accept: application/json" -H  "content-type: application/json" -d @${VARIABLE}
